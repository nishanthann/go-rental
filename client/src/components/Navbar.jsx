...
const Navbar = () => {
  ...
  return (
    <motion.div
      ...
      className={`flex items-center justify-between px-6 md:px-6 lg:px-24 xl:px-32 
    ...
    >
      ...
      >
        {/* search bar on ly for small screen */}
        <div className="flex lg:hidden items-center text-sm gap-2 border border-borderColor px-3 rounded-full max-w-56">
          <input
            type="text"
