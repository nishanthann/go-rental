...
const MyBooking = () => {
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 2xl:px-48 mt-16 text-sm max-w-7xl'>
        <Title title='My Bookings'subtitle='View and manage all bookings' align='left'/>

        <div>
          {bookings.map((booking,index)=>(
            <div key={booking._id}className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-borderColor rounded-lg mt-15 first:mt-12'>
                ...
                <div className=' md:col-span-2'>
                  ...
                  <div className='flex items-start gap-2 mt-3'>
                    ...
                    <div className='flex items-start gap-2 mt-3'>
                      ...
                      <div>
                        <p className='text-gray-500'>Pick-ip Location</p>
