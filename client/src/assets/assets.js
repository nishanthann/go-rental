...
export const cityList =[
  ...
  // Historic
  'Anuradhapura', 'Polonnaruwa', 'Sigiriya', 'Dambulla', 'Ratnapura',
  
  // Coastal
  'Bentota', 'Mirissa', 'Hikkaduwa', 'Batticaloa', 'Kalpitiya',
  
  // Hill Country
  'Nuwara Eliya', 'Ella', 'Badulla', 'Bandarawela'
]
...
export const ownerMenuLinks = [
    ...
    { name: "Manage vehicles", path: "/owner/manage-cars", icon: carIcon, coloredIcon: carIconColored },
    { name: "Manage Booking", path: "/owner/manage-booking", icon: listIcon, coloredIcon: listIconColored },
]
